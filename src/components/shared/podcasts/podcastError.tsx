// components/shared/podcasts/podcastError.tsx
'use client'
...
export function PodcastError({ onRetry }: PodcastErrorProps) {
  return (
        ...
        <div className="flex flex-col items-center justify-center py-24 md:py-32 px-4">
          ...
          <div className="mt-8 text-center space-y-2">
            ...
            <p className="text-gray-600 text-sm md:text-base max-w-md">
              We couldn&apos;t fetch the podcast episodes. Please check your
